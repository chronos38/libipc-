...
int main()
{
    ...
    /// Pipe
    ///////////////////////////////////////////////////////////////////////////
    ipc::IOBase* iobase = new ipc::Pipe();
    result << "Pipe_8_10000_readwrite: " << CallIpcType(*iobase, 8, 10000, ReadWrite).count() << "ms\n";
    result << "Pipe_8_20000_readwrite: " << CallIpcType(*iobase, 8, 20000, ReadWrite).count() << "ms\n";
    result << "Pipe_8_30000_readwrite: " << CallIpcType(*iobase, 8, 30000, ReadWrite).count() << "ms\n";
    result << "Pipe_8_40000_readwrite: " << CallIpcType(*iobase, 8, 40000, ReadWrite).count() << "ms\n";
    result << "Pipe_8_50000_readwrite: " << CallIpcType(*iobase, 8, 50000, ReadWrite).count() << "ms\n";
    result << "Pipe_8_60000_readwrite: " << CallIpcType(*iobase, 8, 60000, ReadWrite).count() << "ms\n";
    result << "Pipe_8_70000_readwrite: " << CallIpcType(*iobase, 8, 70000, ReadWrite).count() << "ms\n";
    result << "Pipe_8_80000_readwrite: " << CallIpcType(*iobase, 8, 80000, ReadWrite).count() << "ms\n";
    result << "Pipe_8_90000_readwrite: " << CallIpcType(*iobase, 8, 90000, ReadWrite).count() << "ms\n";
    result << "Pipe_8_100000_readwrite: " << CallIpcType(*iobase, 8, 100000, ReadWrite).count() << "ms\n";
    result << "Pipe_128_10000_readwrite: " << CallIpcType(*iobase, 128, 10000, ReadWrite).count() << "ms\n";
    result << "Pipe_128_20000_readwrite: " << CallIpcType(*iobase, 128, 20000, ReadWrite).count() << "ms\n";
    result << "Pipe_128_30000_readwrite: " << CallIpcType(*iobase, 128, 30000, ReadWrite).count() << "ms\n";
    result << "Pipe_128_40000_readwrite: " << CallIpcType(*iobase, 128, 40000, ReadWrite).count() << "ms\n";
    result << "Pipe_128_50000_readwrite: " << CallIpcType(*iobase, 128, 50000, ReadWrite).count() << "ms\n";
    result << "Pipe_128_60000_readwrite: " << CallIpcType(*iobase, 128, 60000, ReadWrite).count() << "ms\n";
    result << "Pipe_128_70000_readwrite: " << CallIpcType(*iobase, 128, 70000, ReadWrite).count() << "ms\n";
    result << "Pipe_128_80000_readwrite: " << CallIpcType(*iobase, 128, 80000, ReadWrite).count() << "ms\n";
    result << "Pipe_128_90000_readwrite: " << CallIpcType(*iobase, 128, 90000, ReadWrite).count() << "ms\n";
    result << "Pipe_128_100000_readwrite: " << CallIpcType(*iobase, 128, 100000, ReadWrite).count() << "ms\n";
    result << "Pipe_4096_10000_readwrite: " << CallIpcType(*iobase, 4096, 10000, ReadWrite).count() << "ms\n";
    result << "Pipe_4096_20000_readwrite: " << CallIpcType(*iobase, 4096, 20000, ReadWrite).count() << "ms\n";
    result << "Pipe_4096_30000_readwrite: " << CallIpcType(*iobase, 4096, 30000, ReadWrite).count() << "ms\n";
    result << "Pipe_4096_40000_readwrite: " << CallIpcType(*iobase, 4096, 40000, ReadWrite).count() << "ms\n";
    result << "Pipe_4096_50000_readwrite: " << CallIpcType(*iobase, 4096, 50000, ReadWrite).count() << "ms\n";
    result << "Pipe_4096_60000_readwrite: " << CallIpcType(*iobase, 4096, 60000, ReadWrite).count() << "ms\n";
    result << "Pipe_4096_70000_readwrite: " << CallIpcType(*iobase, 4096, 70000, ReadWrite).count() << "ms\n";
    result << "Pipe_4096_80000_readwrite: " << CallIpcType(*iobase, 4096, 80000, ReadWrite).count() << "ms\n";
    result << "Pipe_4096_90000_readwrite: " << CallIpcType(*iobase, 4096, 90000, ReadWrite).count() << "ms\n";
    result << "Pipe_4096_100000_readwrite: " << CallIpcType(*iobase, 4096, 100000, ReadWrite).count() << "ms\n\n";
    delete iobase;

    ///////////////////////////////////////////////////////////////////////////
    /// SharedMemory
    ///////////////////////////////////////////////////////////////////////////
    iobase = new ipc::SharedMemory(819200000);
    result << "SharedMemory_8_10000_readwrite: " << CallIpcType(*iobase, 8, 10000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_8_20000_readwrite: " << CallIpcType(*iobase, 8, 20000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_8_30000_readwrite: " << CallIpcType(*iobase, 8, 30000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_8_40000_readwrite: " << CallIpcType(*iobase, 8, 40000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_8_50000_readwrite: " << CallIpcType(*iobase, 8, 50000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_8_60000_readwrite: " << CallIpcType(*iobase, 8, 60000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_8_70000_readwrite: " << CallIpcType(*iobase, 8, 70000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_8_80000_readwrite: " << CallIpcType(*iobase, 8, 80000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_8_90000_readwrite: " << CallIpcType(*iobase, 8, 90000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_8_100000_readwrite: " << CallIpcType(*iobase, 8, 100000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_128_10000_readwrite: " << CallIpcType(*iobase, 128, 10000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_128_20000_readwrite: " << CallIpcType(*iobase, 128, 20000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_128_30000_readwrite: " << CallIpcType(*iobase, 128, 30000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_128_40000_readwrite: " << CallIpcType(*iobase, 128, 40000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_128_50000_readwrite: " << CallIpcType(*iobase, 128, 50000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_128_60000_readwrite: " << CallIpcType(*iobase, 128, 60000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_128_70000_readwrite: " << CallIpcType(*iobase, 128, 70000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_128_80000_readwrite: " << CallIpcType(*iobase, 128, 80000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_128_90000_readwrite: " << CallIpcType(*iobase, 128, 90000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_128_100000_readwrite: " << CallIpcType(*iobase, 128, 100000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_4096_10000_readwrite: " << CallIpcType(*iobase, 4096, 10000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_4096_20000_readwrite: " << CallIpcType(*iobase, 4096, 20000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_4096_30000_readwrite: " << CallIpcType(*iobase, 4096, 30000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_4096_40000_readwrite: " << CallIpcType(*iobase, 4096, 40000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_4096_50000_readwrite: " << CallIpcType(*iobase, 4096, 50000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_4096_60000_readwrite: " << CallIpcType(*iobase, 4096, 60000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_4096_70000_readwrite: " << CallIpcType(*iobase, 4096, 70000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_4096_80000_readwrite: " << CallIpcType(*iobase, 4096, 80000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_4096_90000_readwrite: " << CallIpcType(*iobase, 4096, 90000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::SharedMemory*>(iobase)->Position(0);
    result << "SharedMemory_4096_100000_readwrite: " << CallIpcType(*iobase, 4096, 100000, ReadWrite).count() << "ms\n\n";
    delete iobase;

    ///////////////////////////////////////////////////////////////////////////
    /// MemoryMap
    ///////////////////////////////////////////////////////////////////////////
    iobase = new ipc::MemoryMap(819200000);
    result << "MemoryMap_8_10000_readwrite: " << CallIpcType(*iobase, 8, 10000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_8_20000_readwrite: " << CallIpcType(*iobase, 8, 20000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_8_30000_readwrite: " << CallIpcType(*iobase, 8, 30000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_8_40000_readwrite: " << CallIpcType(*iobase, 8, 40000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_8_50000_readwrite: " << CallIpcType(*iobase, 8, 50000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_8_60000_readwrite: " << CallIpcType(*iobase, 8, 60000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_8_70000_readwrite: " << CallIpcType(*iobase, 8, 70000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_8_80000_readwrite: " << CallIpcType(*iobase, 8, 80000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_8_90000_readwrite: " << CallIpcType(*iobase, 8, 90000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_8_100000_readwrite: " << CallIpcType(*iobase, 8, 100000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_128_10000_readwrite: " << CallIpcType(*iobase, 128, 10000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_128_20000_readwrite: " << CallIpcType(*iobase, 128, 20000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_128_30000_readwrite: " << CallIpcType(*iobase, 128, 30000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_128_40000_readwrite: " << CallIpcType(*iobase, 128, 40000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_128_50000_readwrite: " << CallIpcType(*iobase, 128, 50000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_128_60000_readwrite: " << CallIpcType(*iobase, 128, 60000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_128_70000_readwrite: " << CallIpcType(*iobase, 128, 70000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_128_80000_readwrite: " << CallIpcType(*iobase, 128, 80000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_128_90000_readwrite: " << CallIpcType(*iobase, 128, 90000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_128_100000_readwrite: " << CallIpcType(*iobase, 128, 100000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_4096_10000_readwrite: " << CallIpcType(*iobase, 4096, 10000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_4096_20000_readwrite: " << CallIpcType(*iobase, 4096, 20000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_4096_30000_readwrite: " << CallIpcType(*iobase, 4096, 30000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_4096_40000_readwrite: " << CallIpcType(*iobase, 4096, 40000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_4096_50000_readwrite: " << CallIpcType(*iobase, 4096, 50000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_4096_60000_readwrite: " << CallIpcType(*iobase, 4096, 60000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_4096_70000_readwrite: " << CallIpcType(*iobase, 4096, 70000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_4096_80000_readwrite: " << CallIpcType(*iobase, 4096, 80000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_4096_90000_readwrite: " << CallIpcType(*iobase, 4096, 90000, ReadWrite).count() << "ms\n";
    dynamic_cast<ipc::MemoryMap*>(iobase)->Position(0);
    result << "MemoryMap_4096_100000_readwrite: " << CallIpcType(*iobase, 4096, 100000, ReadWrite).count() << "ms\n\n";
    delete iobase;
