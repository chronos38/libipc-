namespace ipc {
    ...
    ByteCount SharedMemory::Write(InputIt first, InputIt last) const throw(SharedMemoryException)
    {
    ...
    ByteCount SharedMemory::Read(OutputIt first, OutputIt last) const throw(SharedMemoryException)
    {
